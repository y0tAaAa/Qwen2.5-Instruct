...
log = logging.getLogger("train_detect_v2")
...
def main():
    ...
    ap.add_argument("--train_path", default="data/processed/train_detect.jsonl")
    ap.add_argument("--val_path", default=None)
    ap.add_argument("--out_dir", default="checkpoints/qwen-cipherchat-detect-v2")
