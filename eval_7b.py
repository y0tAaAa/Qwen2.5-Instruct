...
eval_7b.py
----------
Evaluation script for cipherchat-7b-20260306_153334.
...
Usage:
  python eval_7b.py                          # uses defaults
...
DEFAULT_ADAPTER = "checkpoints/cipherchat-7b-20260306_153334/final_adapter"
...
def main():
    ap = argparse.ArgumentParser(
        description="Evaluate cipher-instruct-7B model (base vs fine-tuned)."
    )
