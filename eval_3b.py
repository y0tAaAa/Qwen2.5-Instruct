...
eval_3b.py
----------
Evaluation script for cipher-instruct-3B-20260320_235526.
...
Usage:
  python eval_3b.py                          # uses defaults
...
DEFAULT_ADAPTER = "checkpoints/cipher-instruct-3B-20260320_235526/final_adapter"
...
def main():
    ap = argparse.ArgumentParser(
        description="Evaluate cipher-instruct-3B model (base vs fine-tuned)."
    )
